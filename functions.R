...
default1 <- function(exp) {
    ...
    return(FA_network_data)
}

default2 <- function(exp) {
    load('data/required_data.RData')
    ...
    return(species_network_data)
}

default3 <- function(exp) {
    built <- build_char_table(raw_data = exp, network_node = network_node)
    ...
    return(class_network_data)
}

processCVD <- function(file1, file2) {
    ...
    pdf("~/Code/iLipidome-website/CVDtest.pdf")
    #print(F6b) these two commented are visnetworks, find out how to render to pdf
    print(SF4c)
    print(SF4e)
    #print(SF5c)
    print(SF4b)
...
processDHA <- function(file1, file2) {
    load("~/Code/iLipidome/DHA/DHA.RData")
...
processKO <- function(file1, file2) {
    # file <- dirname(rstudioapi::getSourceEditorContext()$path)
...
processLPCAT <- function(file1, file2, file3) {
    # file <- dirname(rstudioapi::getSourceEditorContext()$path)
